                    ...
                    <div class="wsus__dash_pro_area">
                        ...
                        <form action="{{ route('vendor.products.update', $product->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group wsus__input">
                                        ...
                                        <select name="sub_category_id" id="sub_category" class="form-control sub-category">
                                            <option value="">Select</option>
                            ...
                            <div class="form-group wsus__input">
                                ...
                                <textarea name="seo_description" id="seo_description" class="form-control summernote">{!! $product->seo_description !!}</textarea>
                            </div>
            ...
            $('body').on('change', '.main-category, .sub-category', function(e) {
                ...
                $.ajax({
                    ...
                    url: targetClass === 'sub-category' ?
                        "{{ route('vendor.product.get-subcategories') }}" :
                        "{{ route('vendor.product.get-child-categories') }}",
                    data: {
                        id: id
                    },
